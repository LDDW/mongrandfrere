    ...
    <section>
        <div>
            ...
            <div class="bg-white p-4 rounded-xl w-3/5 mx-auto">
                <h1 class="text-lg lg:text-4xl font-medium mb-2">“Mon Grand Frère t’accompagne pour : trouver un <span class="text-[#57C5B6] font-bold">stage</span>, une <span class="text-[#57C5B6] font-bold">alternance</span> ou alors ton <span class="text-[#57C5B6] font-bold">métier de rêve</span> !”</h1>
        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="bg-white p-3 rounded-xl">
                ...
                <p>Aide à la construction d'un CV</p>
            </div>
            ...
            <div class="bg-white p-3 rounded-xl">
                ...
                <p>Préparation pour un entretien</p>
            </div>
