...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-[#57C5B6] text-left text-base font-medium text-[#57C5B6] bg-[#DFEEEC] focus:outline-none focus:text-[#57C5B6] focus:bg-indigo-100 focus:border-indigo-700 transition duration-150 ease-in-out'
