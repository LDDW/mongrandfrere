<footer class="w-full bg-[#57C5B6] px-6 lg:px-20 xl:px-44">
    ...
    <div class="w-full lg:flex lg:items-center lg:justify-center lg:gap-2 text-sm text-[#DCF2ED] pt-3 pb-8 px-6 text-center lg:text-left">
        <a href="{{ route('terms.sale.show') }}" class="block underline lg:underline-offset-0">Conditions générales de vente</a>
        <span class="hidden lg:block">-</span>
        <a href="{{ route('terms.use.show') }}" class="block underline">Conditions générales d'utilisation</a>
        <span class="hidden lg:block">-</span>
        <a href="{{ route('legal.notice.show') }}" class="block underline">Mentions légales</a>
        <span class="hidden lg:block">-</span>
